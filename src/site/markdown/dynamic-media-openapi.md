...
When using the Remote Asset Picker in the authoring environment, it is possible to customize the configuration passed to the asset selector (e.g. to enable multi-select or add custom filters) via a JavaScript Event.
