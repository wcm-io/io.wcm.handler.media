...
class MediaHandlerImplImageFileTypesEnd2EndWebOptimizedImageDeliveryTest extends MediaHandlerImplImageFileTypesEnd2EndTest {
  ...
  void testAsset_JPEG_Original() {
    ...
    buildAssertMedia(asset, 100, 50,
        "/adobe/dynamicmedia/deliver/" + getAssetId(asset) + "/sample.jpg?preferwebp=true&quality=85",
        ContentType.JPEG);
  }
  ...
  void testAsset_GIF_Original() {
    ...
    buildAssertMedia(asset, 100, 50,
        "/adobe/dynamicmedia/deliver/" + getAssetId(asset) + "/sample.gif?preferwebp=true&quality=85",
        ContentType.GIF);
  }
  ...
  void testAsset_PNG_Original() {
    ...
    buildAssertMedia(asset, 100, 50,
        "/adobe/dynamicmedia/deliver/" + getAssetId(asset) + "/sample.png?preferwebp=true&quality=85",
        ContentType.PNG);
  }
