...
class DamUriTemplateTest {
  ...
  void testGetUriTemplate_CropCenter() {
    ...
    assertUriTemplate(media, UriTemplateType.CROP_CENTER, 100, 50,
  ...
  void testGetUriTemplate_ScaleWidth() {
    ...
    assertUriTemplate(media, UriTemplateType.SCALE_WIDTH, 100, 50,
  ...
  void testGetUriTemplate_ScaleHeight() {
    ...
    assertUriTemplate(media, UriTemplateType.SCALE_HEIGHT, 100, 50,
